        ...
        this.state.selectedOption === "relais"
          ? <div className="flex_r width80">
              ...
              <div className="flex_c w50">
                <div className="flex_r box_dark3 givemespace infoShop"> <img src='./images/relaiscolis.gif' alt="Information livraison gratuite" style={{width : '50px'}} className="givemespace"></img> Livraison GRATUITE</div>

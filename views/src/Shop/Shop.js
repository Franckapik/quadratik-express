...
class CollectionsList extends Component {
  ...
  render() {
    ...
    <div className="flex_r box_dark3 givemespace infoShop"> <img alt="Livraison gratuite" src='./images/relaiscolis.gif' style={{width : '50px'}} className="givemespace"></img> <strong>Désormais la livraison est <span className="strongColor">GRATUITE</span> si vous choisissez de recevoir vos colis en <span className="strongColor">Point Relais</span> !</strong></div>

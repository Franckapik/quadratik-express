  ...
  return (
    <div className="box_light1 box_news flex_c givemespace">
      <div className="flex_r left">
        ...
        <img alt="Vignette" src={props.img} className="givemespace vignette mobile_hide"></img>
    ...
    return (<div>
      {
        ...
        ? this.state.news.sort(function (a, b) { return b.id - a.id;}).slice(this.props.first,this.props.second).map((a, i) => {
            return (
              <BoxNews img={a.img} alt="Actualités" title={a.titre} description={a.description}></BoxNews>
            )
          })
          : "Chargement"
      }

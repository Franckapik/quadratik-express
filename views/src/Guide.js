  ...
  return (<div id="guide">
    ...
    <div className="sommaire box_dark1">
      ...
      <ul>
        ...
        <li>
          <a href="#2d">
            Les limites du diffuseur acoustique
          </a>
        </li>
      </ul>
      <p/>
    ...
    <div className="guide_container">
      ...
      <div className="box_light2">
        ...
        <p/>
        Que ce soit dans un local de répétition de musique, devant une table de mixage ou encore dans votre canapé entouré de votre home cinéma, il existe un phénomène responsable de la déformation d’un son :
        <strong>l’acoustique.</strong>
        <p/>
        <p></p>
        <p>L’acoustique est pourtant essentielle pour nos oreilles afin de reconnaître, souvent de manière inconsciente, l’environnement dans lequel nous nous situons chaque jour.
        </p>
        <p>
        ...
        <p>
          Se placer dans un environnement sans aucun obstacle au son. Faut-il alors produire un album en plein milieu d’un champ, en espérant ne pas enregistrer le bruit d'une vache en fond ?
        </p>
        <p>
          Je ne pense pas ! ;)
        </p>
        <p></p>
        <p>L’acoustique d’une pièce ne se supprime pas, elle se maîtrise !
        </p>
        <p/>
        ...
        <p></p>
        <p>
          Les meilleures enceintes du monde, placées dans une salle de bain, donneront un son...de salle de bain!
        </p>
        <p></p>
        <p>
        ...
        <p>Prenons un exemple. Dans un local de répétition de musique, disons Roger, un batteur se plaint de ne pas entendre les autres instruments et il n’aime pas le son de sa caisse claire dans la pièce. Et lorsqu’il tape sur ses tom, il entend la porte vibrer…
        </p>
        <p>
        ...
        <p></p>
        <img src="images/image5.png" alt="comportement du son face à un obstacle"/>
        <p>Finalement, tout traitement acoustique consiste alors à jouer avec ces trois comportements. Il est important de comprendre que toute inovation future sera toujours basée sur ces trois bases solides.
        </p>
        <p></p>
        <p>Facile, non?
        </p>
        <p/>
        Continuons avec mon expérience rencontrée lors de la construction d’un Home studio. J’achète des mousses acoustiques peu chères et très efficaces chez mon leader européen du studio de musique (doit-on citer Thomann aujourd'hui hein?) … Je rajoute des panneaux pour les fréquences médiums et quelques bass traps. En d’autres mots, j’absorbe tout ce qui passe !<p/>
        <p>
        ...
        <ul className="guide_liste">
          <li>
            répartition homogène dans la pièce.
          </li>
          <li>
            suppression de flutter echo
          </li>
          <li>
            une impression d’être entouré par le son
          </li>
          <li>
            le son est plus aéré, clair et précis
          </li>
          <li>
            sensation d’avoir une pièce beaucoup plus grande
          </li>
        </ul>
        <p></p>
        <h2>
        ...
        <p>
          Si le son vous parait trop étouffé (mat), si vous entendez une résonance métallique, ou encore un son peu agréable, vous avez besoin de diffuseurs !
        </p>
        <p></p>
        <p>
          Le deuxième test possible est de se munir
          <a href="http://www.szynalski.com/tone-generator/" style={{
              textDecoration: 'underline'
            }}>d’un générateur de fréquence</a>. Avec votre volume d'écoute habituel, jouer les fréquences au dessus de 400hz, et placez vous dans un endroit de la pièce. Restez tout d’abord statique pour constater la régularité du son. Et bouger ensuite votre tête puis tout votre corps dans la pièce. Si vous constater des différences de volume, avec un effet de vague de son, vous avez besoin de diffuseurs !
        </p>
        <p></p>
        <h3 id="2b">
        ...
        <p></p>
        <p>
          Il existe également des tests avancés en réalisant des mesures acoustiques avec un micro, tel que vous le ferait un acousticien. J’utilise de temps en temps dans mon métier un programme gratuit, extremement efficace :
          <a href="https://www.roomeqwizard.com/" style={{
              textDecoration: 'underline'
            }}>
            REW</a>. Il existe des tutoriels sur internet qui expliquent la mise en oeuvre. N hésitez pas à me contacter également si vous avez des questions à propos de son utilisation. Un petit conseil totalement gratuit au téléphone fait toujours plaisir et donne du sens à mon métier. :)
        </p>
        <p></p>
        <p>
        ...
        <p></p>
        <p>
          <img src="images/image8.jpg" alt="Mesure acoustique à l'aide du logiciel REW"/>
        </p>
        <p></p>
        <p>
        ...
        <p></p>
        <p>
          En d’autres termes, lorsque deux mêmes sons se rencontrent dans une pièce, soit on ne l’entend plus soit on l’entend deux fois plus fort !
        </p>
        <p></p>
        <p>
          Cette règle permet d’expliquer pourquoi le son peut-être différent selon votre position dans la pièce. Et savez-vous ce qui facilite la rencontre d’une même fréquence, et cela un grand nombre de fois ? Les surfaces parallèles ! Ne me dites pas que votre pièce forme un rectangle !?? (serais-je ironique?)
        </p>
        <p></p>
        <p>
        ...
        <p/>
        <img src="images/image3.png" alt="Diagramme de Bolt"/>
        <p>
        ...
        <p></p>
        <ul className="guide_liste">
          <li>1- Une onde sonore qui arrive sur un diffuseur entre en contact avec des cellules de différentes profondeur, induisant des rebonds dans de multiples directions.
          </li>
          <li>2- Plus la profondeur de ces cellules est importante, plus le diffuseur sera efficace avec les basses fréquences.
          </li>
          <li>3- Plus les cellules sont étroites, plus le diffuseur sera efficace dans les aigus.
          </li>
          <li>4- Plus le nombre de cellules est important, plus le nombre de rebonds est important et plus le phénomène de diffusion sera meilleur.
          </li>
        </ul>
        <p></p>
        <h3 id="3b">
        ...
        <p></p>
        <img src="images/image2.png" alt="Les différents types de diffuseurs acoustiques"/>
        <p>
        ...
        <ul className="guide_liste">
          <li>
            La position des diffuseurs acoustiques est privilégiée
            <strong>
              derrière
            </strong>
            le point d’écoute.
          ...
          <li>
            ...
            <strong>
              en avant
            </strong>du point d’écoute et sur les surfaces latérales au plus près des sources du son.
          </li>
        </ul>
        <p></p>
        <p>
        ...
        <p></p>
        <p>Traiter une onde sonore au bout de son 356ème rebond est en effet beaucoup moins efficace. On distingue ces rebonds selon leur position dans le temps après l'émission d’un son.
        </p>
        <p/>
        Voici ce que l’on appelle une réponse impulsionnelle, une distribution du son dans le temps, suite à un claquement de main par exemple.<p/>
        <img src="images/image6.png" alt="Réponse impulsionnelle"/>
        <p></p>
        <p>
        ...
        <ul className="guide_liste">
          <li>
            ...
            <a href="/">murs parallèles?
            </a>
            Éléments diffusant dans la pièce ?
          </li>
          <li>
            la place disponible
          </li>
          <li>
            le budget (erf bah oui hein...)
          </li>
        </ul>
        <p></p>
        <p>
